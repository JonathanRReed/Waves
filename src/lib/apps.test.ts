...
import { buildViewApps, filterViewApps, hasValidSessionIdentity, partitionViewApps, type RecentActivityMap, type VolumeDrafts } from './apps'
...
describe('app helpers', () => {
  ...
  test('keeps recently active sessions in the live section during the short hold window', () => {
    const recentActivity: RecentActivityMap = {
      chrome: 5_000,
    }
